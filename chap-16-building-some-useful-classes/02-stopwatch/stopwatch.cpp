...
Stopwatch::Stopwatch():
    start_time(0), running(false), elapsed_time(0.0) {}
...
// Stops the stopwatch.
// The stopwatch will retain the current elapsed time,
...
// Reports the cummulative time in seconds
// since the stopwatch was last reset.
...
double Stopwatch::elapsed() const
{
    ...
    {
        // Timer stopped; elapsed already computed in the stop method
        return elapsed_time;
    }
}

// Returns the stopwatch's status (running or not) to the client
// This methoid does not affect the state of the stopwatch
